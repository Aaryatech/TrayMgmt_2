...
public class TrayMgmtDetailData {
    ...
    public TrayMgmtDetailData(int tranDetailId, int tranId, int frId, String frName, int outtrayBig, int outtraySmall, int outtrayLead, int outtrayExtra, String outtrayDate, int intrayBig, int intraySmall, int intrayLead, int intrayExtra, String intrayDate, int intrayBig1, int intraySmall1, int intrayLead1, int intrayExtra1, String intrayDate1, int intrayBig2, int intraySmall2, int intrayLead2, int intrayExtra2, String intrayDate2, int balanceBig, int balanceSmall, int balanceLead, int balanceExtra, float priceBig, float priceSmall, float priceLead, float priceExtra, int qtyBig, int qtySmall, int qtyLead, int qtyExtra, float gstPer, float gstRs, float taxableAmt, float taxAmt, float grandTotal, int trayStatus, int depositIsUsed, int isSameDay, int delStatus) {
